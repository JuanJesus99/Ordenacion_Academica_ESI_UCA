...
def start_group_assignment(update, context):
    ...
    query.edit_message_text(
        text = 'Enlaces a las webs oficiales de la escuela',
        reply_markup = InlineKeyboardMarkup([
            [InlineKeyboardButton(text='Grado en Ingeniería Aeroespacial', url='https://esingenieria.uca.es/docencia/grados/gia/horarios/')],
            [InlineKeyboardButton(text='Grado en Ingeniería en Diseño Industrial y Desarrollo del Producto', url='https://esingenieria.uca.es/docencia/grados/gididp/horarios/')],
            ...
            [InlineKeyboardButton(text='Grado en Ingeniería Informática', url='https://esingenieria.uca.es/docencia/grados/gii/horarios/')],
...
def group_assignment_start_english(update, context):
    ...
    query.edit_message_text(
        ...
        reply_markup = InlineKeyboardMarkup([
             [InlineKeyboardButton(text='Degree in Aerospace Engineering', url='https://esingenieria.uca.es/docencia/grados/gia/horarios/')],
            [InlineKeyboardButton(text='Degree in Industrial Design and Product Development Engineering', url='https://esingenieria.uca.es/docencia/grados/gididp/horarios/')],
            ...
            [InlineKeyboardButton(text='Degree in Computer Engineering', url='https://esingenieria.uca.es/docencia/grados/gii/horarios/')],
